...
def solve_min_time(csv_file='Nuerburgring.csv', ds=2,
    ...
    # 在这里设置求解器迭代次数
    solver = ca.nlpsol("solver", "ipopt", nlp, {"ipopt.print_level": 5, "print_time": False,"ipopt.max_iter": 1350})
...
if __name__ == "__main__":
    solve_min_time('Monza.csv', ds=3,
                   ...
                   a_brake=10.0, vsafe_mode='curvature', ay_limit=8.0, default_look=200.0)
